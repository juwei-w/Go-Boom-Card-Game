    ...
    public static void checkPlayable() {
        if (center.size() != 0) {
            ...
            for (Card card : currentPlayer.playerCards) {
                ...
                else if (card.getSuit().toString().equals(leadCard.getSuit().toString())) {
                    // System.out.println("Same suit 2");
                    currentPlayer.playableCard = true;
                }
                else if (compareRanks(card.getRank(), leadCard.getRank()) == 0) {
                    // System.out.println("Same rank 2");
                    currentPlayer.playableCard = true;
                }

            }
            if (currentPlayer.playableCard == false) {
                System.out.println(" ");
